...
try:
    ...
    update_player = ("UPDATE player SET team_id = 2, first_name = 'Peter', last_name = 'Cotton Tail' WHERE first_name = 'Johnny'")
    ...
    delete_player = ("DELETE FROM player WHERE first_name = 'Peter'")
