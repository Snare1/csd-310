...
def validate_user():
    ...
    try:
        ...
        if user_id < 0 or user_id > 3:
            print("\n  Invalid customer number, program ended...\n")
            sys.exit(0)
...
try:
    ...
    print("\n  Welcome to the WhatABook E-store! ")
